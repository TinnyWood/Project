...
<head>
    ...
    <!-- Main Styling -->
    <link rel="stylesheet" href="{{ asset('css/soft-ui-dashboard-tailwind.css?v=1.0.5') }}">
            ...
            <div class="w-full max-w-full px-3 flex-0">
                ...
                <nav class="absolute top-0 left-0 right-0 z-30 flex flex-wrap items-center px-4 py-2 mx-6 my-4 shadow-soft-2xl rounded-blur bg-white/80 backdrop-blur-2xl backdrop-saturate-200 lg:flex-nowrap lg:justify-start">
                    <div class="flex items-center justify-between w-full p-0 pl-6 mx-auto flex-wrap-inherit">
                        <a class="py-2.375 text-sm mr-4 ml-4 whitespace-nowrap font-bold text-slate-700 lg:ml-0" href="#"> E-Checksheet Usage History </a>
                ...
                <div class="container z-10">
                    <div class="flex flex-wrap mt-0 -mx-3">
                        <div class="flex flex-col w-full max-w-full px-3 mx-auto md:flex-0 shrink-0 md:w-6/12 lg:w-5/12 xl:w-4/12">
                            <div class="relative flex flex-col min-w-0 mt-32 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                    <h3 class="relative z-10 font-bold text-transparent bg-gradient-to-tl from-blue-600 to-cyan-400 bg-clip-text"> LOGIN</h3>
                        ...
                        <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
                            <div class="absolute top-0 hidden w-2/5 h-full overflow-hidden -skew-x-10 -right-30 rounded-bl-xl md:block">

                                <div class="absolute inset-x-0 top-0 z-0 h-full -ml-14 bg-cover skew-x-10" style="background-image: url(' {{ asset('img/curved-images/login.jpg') }}')"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- main script file  -->
<script src="{{ asset('js/plugins/soft-ui-dashboard-tailwind.js?v=1.0.5') }}" async></script>
